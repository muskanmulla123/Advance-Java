...
<body>
<form:form method="post" action="/SpringMVCCRUDDemo/product/updateproduct" modelAttribute="product" enctype="multipart/form-data">
    ...
    <div>Image: <form:input type="file" path="file"/></div>
